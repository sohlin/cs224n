...
if args.variant == 'vanilla':
    ...
    model = GPT(mconf) # TODO [part g]: Make some other model here
...
if args.function == 'pretrain':
    ...
    trainer = Trainer(model, pretrain_dataset, None, tconfig)
    trainer.train()
    ...
    # combina dataset with pretrained dataset
    train_dataset = dataset.NameDataset(pretrain_dataset, text)
    trainer = Trainer(model, train_dataset, None, tconfig)
    trainer.train()
