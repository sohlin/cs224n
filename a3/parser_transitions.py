...
def minibatch_parse(sentences, model, batch_size):
    ...
    while unfinished_parses:
        ...
        for paser, trans in zip(unfinished_parses[:batch_size], transitions):
            paser.parse_step(trans)
        unfinished_parses[:] = [paser for paser in unfinished_parses if paser.is_completed()]
