...
class ModelEmbeddings(nn.Module):
    ...
    def __init__(self, word_embed_size, vocab):
        ...
        self.vocab = vocab
        self.num_embedding = len(self.vocab.char2id)
        ...
        self.cnn = CNN(char_emb_size=self.char_embed_size,
                       word_emb_size=self.word_embed_size,
    ...
    def forward(self, input):
        ...
        input_reshape = input.contiguous().view(sentence_length * batch_size, max_word_length)
        ...
        # -> (sentence_length, batch_size, word_embed_size)
        output = X_word_emb.contiguous().view(sentence_length, batch_size, self.word_embed_size)
